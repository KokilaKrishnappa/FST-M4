-- Load the input
inputFile = LOAD 'hdfs:///user/Kokila/inputs' USING PigStorage('\t') AS (name:chararray, line:chararray);
...
-- rmf gdfs:///user/Kokila/PigProjectOutput;

-- Store the result
STORE result INTO 'hdfs:///user/Kokila/PigProjectOutput';
